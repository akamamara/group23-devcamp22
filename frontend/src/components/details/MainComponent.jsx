			...
			<div>
				<div>
					...
					<p className="mt-2 text-sm text-gray-500">
						Ceritakan yang kamu butuhkan sedetail mungkin, ya.
					</p>
				</div>
			</div>
		);
		...
		return (
			<div className="grid grid-cols-2 gap-5">
				{images?.map((image, ind) => (
					<Paper variant="outlined" sx={{ width: "160px", height: "160px" }}>
						<img
							key={ind}
							src={image}
							className="min-w-[160px] h-[160px] object-cover rounded-[8px]"
						/>
					</Paper>
				))}
